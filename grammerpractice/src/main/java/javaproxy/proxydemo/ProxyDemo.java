...
public class ProxyDemo {
	...
	public static void main(String[] args) {
		...
		LoginService o = (LoginService) Proxy.newProxyInstance(LoginService.class.getClassLoader(), new Class<?>[]{LoginService.class},new javaproxy.proxydemo.MyInvocationHandler());
